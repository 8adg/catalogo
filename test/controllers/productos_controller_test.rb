...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { descr_c: @producto.descr_c, descr_l: @producto.descr_l, image: @producto.image, nombre: @producto.nombre, precio: @producto.precio }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { descr_c: @producto.descr_c, descr_l: @producto.descr_l, image: @producto.image, nombre: @producto.nombre, precio: @producto.precio }
    assert_redirected_to producto_path(assigns(:producto))
  end
